...
def pseudoinstruction_pass(asm_lines, pseudos_dictionary):
    ...
    #for now this does nothing, just assumes there are no pseudoinstructions
    return asm_lines
...
def Assemble(inst, line_num=0, labels=None):
    ...
    #Tip: implement this one instruction as a time as you test, and slowly add to it
...
def Assemble_I_Type_from_fields(imm, rs1, func3, rd, opcode, line_num):
    ...
    #This is an optional helper, not tested directly at all
    #I found it helpful to make all the different I Type variants
...
def parse_labels(asm_list):
    ...
    #raise NotImplementedError
    # Reminder: you this should return 2 things, but probably not these two
    return (asm_list, {})
...
def verify_field_sizes(inst_list, inst_type, line_num):
    ...
    """
    #TODO: this helper is optional and not tested
    #useful for keeping the code in the different Assemble methods clean
    #feel free to change the signature of this helper if you use it
